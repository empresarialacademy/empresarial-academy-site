...
A Empresarial Academy é uma empresa brasileira de consultoria, mentoria e formação em gestão para pequenas e médias empresas (PMEs), fundada por ${siteConfig.founder}. Trabalha lado a lado com empresários e gestores para melhorar gestão, vendas, processos, finanças e liderança — com a metodologia proprietária Gestão 360. Slogan: "${siteConfig.slogan}". Tagline: "Método para crescer. Gestão para permanecer.".
